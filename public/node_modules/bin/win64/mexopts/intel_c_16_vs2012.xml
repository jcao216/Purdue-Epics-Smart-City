...
<config
    Name="Intel Parallel Studio XE 2016 with Microsoft Visual Studio 2012 (C)"
    ShortName="INTELC16MSVS2012"
    Manufacturer="Intel"
    Version="16.0"
    Language="C"
    Priority="X"
   ...
   />
    ...
    <env
        PATH="$CROOT\bin\intel64;$VCROOT\bin\amd64;$VCROOT\bin\VCPackages;$VCROOT\..\Common7\IDE;$VCROOT\..\Common7\Tools;$SDKROOT\bin\x64;$SDKROOT\bin;"
        INCLUDE="$CROOT\include;$CROOT\compiler\include;$VCROOT\INCLUDE;$SDKROOT\include\shared;$SDKROOT\include\um;$SDKROOT\include\winrt;$MATLABROOT\extern\include;"
        LIB="$CROOT\lib\intel64;$CROOT\compiler\lib\intel64;$VCROOT\Lib\amd64;$SDKROOT\Lib\X64;$SDKROOT\lib\win8\um\x64;$MATLABROOT\lib\$ARCH;"
