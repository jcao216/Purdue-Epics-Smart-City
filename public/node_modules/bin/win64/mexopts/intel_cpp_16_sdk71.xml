...
<config
    Name="Intel Parallel Studio XE 2016 for C++ with Microsoft SDK 7.1"
    ShortName="IntelCPP16MSSDK71"
    Manufacturer="Intel"
    Version="16.0"
    Language="C++"
    Priority="X"
    ...
    <vars
        ...
        CMDLINE300="del $EXP $LIB &quot;$TEMPNAME.map&quot; $MANIFEST $ILK"
    ...
    <env
        PATH="$CPPROOT\bin\intel64;$VSROOT\Common7\IDE;$VSROOT\Common7\Tools;$VSROOT\VC\Bin\amd64;$VSROOT\VC\Bin\VCPackages;$SDKROOT\Bin\x64;$SDKROOT\Bin;"
        INCLUDE="$CPPROOT\include;$CPPROOT\compiler\include;$VSROOT\VC\INCLUDE;$SDKROOT\INCLUDE;$SDKROOT\INCLUDE\gl;$MATLABROOT\extern\include;"
        LIB="$CPPROOT\lib\intel64;$CPPROOT\compiler\lib\intel64;$VSROOT\VC\Lib\amd64;$SDKROOT\Lib\X64;$VSROOT\VC\ATLMFC\LIB\AMD64;$MATLABROOT\lib\$ARCH;$MATLABROOT\extern\lib\win64"
        LIBPATH="$CPPROOT\compiler\Lib\Intel64;$VSROOT\VC\Lib\amd64;$SDKROOT\LIB\X64;$VSROOT\VC\ATLMFC\LIB\AMD64;$MATLABROOT\extern\lib\win64"
    />
</config>
