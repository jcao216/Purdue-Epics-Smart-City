...
<config
    Name="Intel Parallel Studio XE 2016 with Microsoft Visual Studio 2015 (C)"
    ShortName="INTELC16MSVS2015"
    Manufacturer="Intel"
    Version="16.0"
    Language="C"
    Priority="X"
    ...
    <vars
          ...
          LINKER="link"
          LINKFLAGS="/nologo /manifest /INCREMENTAL:NO /nologo "
		  LINKTYPE="/DLL"
   ...
   />
    ...
    <locationFinder>
		<CROOT>
			<and>
			   <or>
					<envVarExists name="ICPP_COMPILER16" />					
			  </or>
    ...
    <env
        PATH="$CROOT\bin\intel64;$VCROOT\bin\amd64;$VCROOT\bin\VCPackages;$VCROOT\..\Common7\IDE;$VCROOT\..\Common7\Tools;$SDKROOT\bin\x64;$SDKROOT\bin\x86;"
        INCLUDE="$CROOT\include;$CROOT\compiler\include;$VCROOT\INCLUDE;$VCROOT\ATLMFC\INCLUDE;$KITSROOT\include\10.0.10150.0\ucrt;$SDKROOT\include\shared;$SDKROOT\include\um;$SDKROOT\include\winrt;$MATLABROOT\extern\include;"
        LIB="$CROOT\lib\intel64;$CROOT\compiler\lib\intel64;$VCROOT\Lib\amd64;$VCROOT\ATLMFC\Lib\amd64;$KITSROOT\Lib\10.0.10150.0\ucrt\x64;$SDKROOT\Lib\X64;$SDKROOT\lib\winv6.3\um\x64;$MATLABROOT\lib\$ARCH;"
        LIBPATH="$VCROOT\Lib\amd64;$CROOT\compiler\Lib\Intel64;$SDKROOT\LIB\x64;$VCROOT\\LIB\amd64;$VCROOT\ATLMFC\LIB\amd64;$MATLABROOT\extern\lib\win64;"
    />
</config>
